...
<body>
    <div class="container">
          ...
          <div class="row">
           <div class="col-12">
        <img src="../public/admin/img/logo4.png" alt="" width="100%" height="320px" class="mt-2 mb-2">
            </div>
         </div>
           <div class="row">
            ...
            <div class="col-3">
                ...
                <a href="productlist.php"><input type="submit" value="Back" class="btn btn-info border-dark mb-2"></a>
